    ...
    <section class="content">
      ...
      <!-- Default box -->
          <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="input.php" method="post" name="form" onsubmit="return pelanggan()">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="checkbox" name="status" class="minimal-red" value="member" style="margin-left:55px"> member
                  </div>
                  </div>
        <!-- /.card-body -->
