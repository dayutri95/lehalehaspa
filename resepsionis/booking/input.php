<?php
		...
		$in=mysqli_query($connect,"INSERT IGNORE INTO booking SET kd_booking ='$_POST[kd_booking]',kd_pelanggan='$_POST[kd_pelanggan]',tgl_booking='$tgl_booking',status_book='$_POST[status_book]',diskon='$_POST[diskon]',kd_user='$kd_user'")or die(mysqli_error($connect));
		...
		header("Location:tambah.php?kd_booking=$_POST[kd_booking]&tgl_booking=$_POST[tgl_booking]&kd_pelanggan=$_POST[kd_pelanggan]&kd_therapist=$_POST[kd_therapist]");
